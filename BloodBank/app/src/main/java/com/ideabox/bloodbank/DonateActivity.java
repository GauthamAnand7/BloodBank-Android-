...
public class DonateActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Area_List = ArrayAdapter.createFromResource(this, R.array.bangalore_arrays, android.R.layout.select_dialog_item);
    ...
    private void updateAreaSpinner(String city) {
        ...
        if(city.equals("Hassan"))
        {
            aid = R.array.hassan_arrays;
        }
        else if(city.equals("Bangalore"))
        {
            aid = R.array.bangalore_arrays;
        }
        else if(city.equals("Bhopal"))
        {
            aid = R.array.bhopal_arrays;
        }
        ...
        else if(city.equals("Mysuru"))
        {
            aid = R.array.mysuru_arrays;
        }
        ...
        else if(city.equals("Mangaluru"))
        {
            aid = R.array.mangaluru_arrays;
        }
        else if(city.equals("Kolkata"))
        {
            aid = R.array.kolkata_arrays;
        }
        else if(city.equals("Mumbai"))
        {
            aid = R.array.mumbai_arrays;
        }
